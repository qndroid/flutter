...
const String _kSmallLogoImage = 'logos/logo_small.png';
const String _kGalleryAssetsPackage = 'asset/images';
    ...
    return GestureDetector(
      ...
      child: Card(
        child: Column(
          ...
          children: <Widget>[
            Hero(
              tag: '$_kGalleryAssetsPackage/${recipe.imagePath}',
              child: AspectRatio(
                aspectRatio: 4.0 / 3.0, // 强制4：3的宽高比
                child: Image.asset(
                  recipe.imagePath,
...
class _RecipePageState extends State<RecipePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: ThemeData(
        brightness: Brightness.light,
        primarySwatch: Colors.indigo, //图标和appbar会使用当前颜色来覆盖
