...
class _CategoriesPage extends StatelessWidget {
  ...
  final ValueChanged<Category> onCategoryTap; //系统的回调类，不需用自己再创建各种callback类

  @override
  Widget build(BuildContext context) {
    const double aspectRatio = 160.0 / 180.0;
    final List<Category> categoriesList = categories;
          ...
          : SafeArea(
              ...
              child: WillPopScope(
                ...
                child: Backdrop(
                  ...
                  frontHeading:
                      widget.testMode ? null : Container(height: 24.0),
                  frontLayer: AnimatedSwitcher(
                    ...
                    ///有被点击的某一项，显示这项中的所有子项，没有点击项，则显示目录页
                    child: _category != null
                        ? _DemosPage(_category)
                        : _CategoriesPage(
                            categories:
                                getAllGalleryDemoCategories(_homeData.data)
                                    .toList(),
